...
fluidPage(
  ...
  fluidRow(
    ...
    column(
      ...
      fluidRow(
        h3("Methodology"),
        p("Recidivism is one of society's most persistent yet misunderstood problems. Everyone from politicians to", a("Supreme Court Justices", href= "https://www.themarshallproject.org/2014/12/04/the-misleading-math-of-recidivism#.AQSpHMFig"), "seem to get it wrong. This model uses data from the  to simulate 1,000 parolees released on the same day."),
        h4("Recidivism Rate"),
